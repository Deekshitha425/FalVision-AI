...
if page == "🏠 Home":
    ...
    <div class="hero-section">
        <div class="hero-content">
            ...
            <h1 class="hero-title">
                <span class="hindi-fal-hero">फल</span><span style="color:#ffffff">Vision AI</span>
            </h1>
    ...
    st.markdown("""
    <div class="cta-bar">
        ← Select <strong>Fruit Detection</strong> from the sidebar to begin
    </div>
    """, unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════════════════════
    ...
    <div class="page-header">
        ...
        <p>Upload a fruit image to receive an instant quality assessment powered by MobileNetV2</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown('<div class="detect-success">✅ Model loaded — MobileNetV2 (158 layers, 3 classes)</div>',
                unsafe_allow_html=True)
    ...
    with col_res:
        if uploaded_file and analyse:
            ...
            # Display in order: Good, Mixed, Bad
            ...
            # Store result in session for the panels below
            ...
            <div class="empty-result">
                ...
                <p>Upload a fruit image and click <strong>Analyse Quality</strong> to get started.</p>
            </div>
            """, unsafe_allow_html=True)

    # ── AI Insights + Fruit Info (full width, shown after any prediction) ───
